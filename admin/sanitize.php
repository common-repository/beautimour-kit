 ...
 */
function bk_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function bk_sanitize_email( $email, $setting ) {
 ...
 */
function bk_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function bk_sanitize_html( $html ) {
 ...
 */
function bk_sanitize_image( $image, $setting ) {
 ...
 */
function bk_sanitize_nohtml( $nohtml ) {
 ...
 */
function bk_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function bk_sanitize_number_range( $number, $setting ) {
 ...
 */
function bk_sanitize_select( $input, $setting ) {
